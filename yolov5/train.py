...
import testNumberDetector  # import testNumberDetector.py to get mAP after each epoch
    ...
    for epoch in range(start_epoch, epochs):  # epoch ------------------------------------------------------------------
        ...
        if rank in [-1, 0]:
            ...
            if not opt.notest or final_epoch:  # Calculate mAP
                ...
                results, maps, _ = testNumberDetector.test(data_dict,
        ...
        if not opt.evolve:
            if is_coco:  # COCO dataset
                for m in [last, best] if best.exists() else [last]:  # speed, mAP tests
                    results, _, _ = testNumberDetector.test(opt.data,
                                                            batch_size=batch_size * 2,
                                                            imgsz=imgsz_test,
                                                            conf_thres=0.001,
                                                            iou_thres=0.7,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default='/home/ea/projects/yolov5/models/yolov5m.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default='/home/ea/projects/yolov5/data/OCRSirius.yaml', help='dataset.yaml path')
    parser.add_argument('--hyp', type=str, default='/home/ea/projects/yolov5/data/hyp.OCRSirius.yaml', help='hyperparameters path')
