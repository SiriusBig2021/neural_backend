...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(prog='testNumberDetector.py')
    ...
    if opt.task in ('train', 'val', 'test'):  # run normally
        ...
        # python testNumberDetector.py --task study --data coco.yaml --iou 0.7 --weights yolov5s.pt yolov5m.pt yolov5l.pt yolov5x.pt
