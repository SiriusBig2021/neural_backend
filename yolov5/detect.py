...
# class NumDetector:
#
#     def __init__(self, modelWeights, device):
#         self.device = select_device(device)
#         self.model = attempt_load(modelWeights, map_location=device)
#
#     def predict(self, image):
#         # image preprocessing
#
#         predicts = self.model(image, augment=False)[0]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str,
                        default='/home/ea/projects/yolov5/runs/train/exp26/weights/best.pt', help='model.pt path(s)')
    parser.add_argument('--source', type=str, default='/mnt/data/Datasets/ocr_dataset_val',
